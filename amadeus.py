...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5826638870:AAGC43VEcUY6rjiw2Ps09_D9FBxcIdUqWtY"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'gpt3rutopbot'
username = 'mstislavlegit'
